...
int getLRU(std::deque<int> slots,std::deque<int> pages,int index){
	int pointer = 0;
	std::vector<int> v(pages.begin(),pages.begin()+index);
...
void LRUreplace(std::deque<int> slots,std::deque<int> pages){
